...
Solo developer on a mission to stop crypto scams and protect the community. 33 professional-grade tools available via x402 micropayments on Solana. Each tool returns structured JSON data.
...
Agents auto-discover tools via: `https://x402-sol.cryptorugmuncher.workers.dev/.well-known/x402`
...
- **Tip API:** `https://x402-sol.cryptorugmuncher.workers.dev/tip`
